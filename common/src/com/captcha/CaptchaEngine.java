...
public class CaptchaEngine extends ListImageCaptchaEngine {
	...
	/** 随机背景图片路径 */
	private static final String BACKGROUND_IMAGE_PATH = "/com/captcha/";
...
//		BackgroundGenerator backgroundGenerator = new FileReaderRandomBackgroundGenerator(IMAGE_WIDTH, IMAGE_HEIGHT, new ClassPathResource(BACKGROUND_IMAGE_PATH).getPath());
		UniColorBackgroundGenerator backgroundGenerator = new UniColorBackgroundGenerator(IMAGE_WIDTH, IMAGE_HEIGHT);
